...
<header class="header">
    ...
    <div class="container">
        <div class="row row--spacebetween">
            <a href="/res-tv/customer-experience/" class="header__res-tv"><i class="far fa-play-circle"></i> res-tv</a>
            <div class="header__logo">
                <a href="/"><img src="<?php echo get_template_directory_uri(); ?>/app/img/logo.svg" alt=""></a>
            </div>
            <div class="header__content">
                <section class="search-section search-menu search-menu-small ">
                    <div class="container">
                        <div class="col">
                            <form role="search" method="get" id="searchform"
                                  class="searchform" action="/">
                                <div class="form-group">
                                    <input type="text" placeholder='E.g., “fracture maps”' value="" name="s" id="s"/>
                ...
                <div class="col col-spacebetween">
                    <nav class="header__content__top">
                        <section class="search-section search-menu search-menu-mob ">
                            <div class="container">
                                <div class="col">
                                    <form role="search" method="get" id="searchform"
                                          class="searchform" action="/">
                    ...
                    <nav class="header__content__bottom id<?php the_ID(); ?>">
                        <?php wp_nav_menu( 
                            array(
                                'menu_id'        => 'top-menu',
                                'container'       => '',
...
<section id="search-desctop" class="search-section search-menu">
    <div class="container">
        <div class="col">
            <form role="search" method="get" id="searchform"
                  class="searchform" action="/">
                <div class="form-group">
                    <input autofocus="autofocus" type="text" placeholder='E.g., “fracture maps”' value="" name="s" id="s"/>
<!--                    <input type="submit" id="searchsubmit" value="Поиск" />-->
                    <button type="submit">
                        <i class="far fa-search"></i>
                    </button>
