<?php
/**
* Template Name: Integration Challenge
 */
...
<section class="product product--eye" id="fracscan">
    <div class="container">
        <div class="col">
            <div class="product__short patents puzzle-wrap">
                <div class="puzzle">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0"><tr class="wrapper">
                            ...
                            <td class="ecw-crosswordarea">
                                ...
                                <script type="text/javascript"><!--
                                    ...
                                    CrosswordHeight = 24;
                                    Words = 15;
                                    WordLength = new Array(8, 9, 6, 12, 11, 19, 12, 3, 10, 9, 14, 19, 7, 8, 7);
                                    Word = new Array("FRACHITS", "DEPLETION", "STRAIN", "CONSTRUCTIVE", "POROELASTIC", "WELLBORECOMPRESSION", "INTERFERENCE", "FDI", "MITIGATION", "MAGNITUDE", "FLUIDMIGRATION", "DIRECTCOMMUNICATION", "PRELOAD", "SEVERITY", "LEAKOFF");
                                    Clue = new Array("Two words; In fracking; to come against another wellbore with impact or force",
                                        "Decreased or exhausted volume/pressure",
                                        "Force tending to alter shape. Cause mechanical deformation",
                                        "Causing or leading to development, helping to improve",
                                        "physical force being exerted on one thing by another, type of compression that occurs in a rigid reservoir when a hydraulic fracture is propagated nearby",
                                        "Two words; a hole drilled in the ground to obatin a natural resource; reduction in volume and increase in pressure",
                                        "The process in which two or more elements combine to reinforce or cancel each other",
                                        "Abbreviation, interactions between wells",
                                        "To lessen in force or intensity, make less severe",
                                        "size or amount",
                                        "two words; type of pressure communication where fluid is passed from one region to another",
                                        "Two words; most straightforward type of pressure interaction; establishes a route for moving fluid",
                                        "to fill beforehand",
                                        "intensity or sharpness, as of pain",
                                        "Pressure or fluid dispersion into the formation");
                                    AnswerHash = new Array(84036, 57260, 85094, 92389, 22010, 53714, 51911, 19778, 13943, 74232, 9942, 58339, 65954, 11850, 86766);
                                    WordX = new Array(16, 10, 9, 4, 7, 4, 0, 9, 6, 18, 13, 0, 21, 11, 17);
                                    WordY = new Array(2, 4, 6, 9, 12, 15, 17, 19, 0, 1, 3, 5, 11, 14, 14);
                                ...
                                <button class="button" id="checkbutton" type="button" onclick="CheckClick();" style="display: none;">Check puzzle</button>

                            </td>

                            <td valign="top" class="info-wrapper">
                                ...
                                <div id="answerbox" class="ecw-answerbox" style="display:none;">
                                    ...
                                    <div style="margin-top: 1em;">
                                        <input class="ecw-input" id="wordentry" type="text" size="24" style="font-weight: 400; text-transform:uppercase;" onkeypress="WordEntryKeyPress(event)" onchange="WordEntryKeyPress(event)" />
                                    </div>
                                    <div id="worderror" class="ecw-worderror">
                                    </div>

                                    <table class="button-wrapper" border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-top:1em;"><tbody><tr><td>
                                                <button id="cheatbutton" type="button" class="ecw-input ecw-button button" onclick="CheatClick();">Solve</button>
                                            </td><td align="right">
                                                <button id="okbutton" type="button" class="ecw-input ecw-button button" onclick="OKClick();" style="font-weight: bold;">Ok</button> &nbsp;
                                                <button id="cancelbutton" type="button" class="ecw-input ecw-button button" onclick="DeselectCurrentWord();">Cancel</button>
                                            </td></tr></tbody>
                                    </table>
                                ...
                                <div id="congratulations" class="ecw-answerbox" style="display:none;">
                                    ...
                                    <p>You have completed this <a href="http://www.eclipsecrossword.com" style=" text-decoration:none;">crossword puzzle</a>.
                                    </p>
                                    <p>If you would like to be able to create interactive
                                        <a href="http://www.eclipsecrossword.com" style=" text-decoration:none;">crosswords</a>
